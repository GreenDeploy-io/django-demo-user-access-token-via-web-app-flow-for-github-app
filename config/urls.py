...
from domains.github import views as gh_views
...
urlpatterns += [
    ...
    path("github/login/", gh_views.github_login, name="github_login"),
    path("github/callback/", gh_views.callback, name="callback"),
]
